...
class Stud
{
    public static void main(String[] args) 
    {
        ...
        //Gender  RADIO BUTTON - isSelected() ONLY ONE OPTION
        ...
        //COMBO BOX(items) : getSelectedItem()
        // String colors[] = {"Red", "Green", "Blue"};
        // JComboBox cb = new JComboBox(colors);
        // String(cb.getSelectedItem())

        //CHECKBOX = isSelected() MULTIPLE OPTION
        //Hobbies
        ...
        c2.setBounds(250,160,80,30);
        c3.setBounds(350,160,80,30);
